...
def update_user_state(chat_id, is_active, key_value=None):
    ...
    try:
        ...
        log_message(f"Lỗi khi cập nhật trạng thái người dùng: {e}")
        return False
    finally:
        conn.close()
    ...
    def process_new_data(self, data: Dict):
        ...
        def process():
            try:
                ...
                log_message(f"Lỗi xử lý dữ liệu: {e}")
...
def handle_telegram_updates():
    ...
    while True:
        ...
        try:
            ...
            log_message(f"Lỗi khi lấy updates từ Telegram: {e}")
            time.sleep(5)
        except json.JSONDecodeError as e:
            log_message(f"Lỗi giải mã JSON từ Telegram: {e}")
            time.sleep(5)
        except Exception as e:
            log_message(f"Lỗi không xác định trong handle_telegram_updates: {e}")
            time.sleep(5)
